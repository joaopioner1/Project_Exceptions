...
public class Reservation {
	...
	public Reservation(Integer roomNumber, Date checkIn,Date checkOut) throws DomainExcepction {
	...
	public String updateDates(Date checkIn, Date checkOut) throws DomainExcepction {
		Date now = new Date();
